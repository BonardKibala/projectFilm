...
const TopFilms = () => {
    ...
    return (
        <>
            ...
            <Grid container>
                {
                    TopMovies.length > 0 && TopMovies.slice(0,4).map(movie => <Grid.Column mobile={16} tablet={8} computer={4} className="cardColumn"><MoviesCard key={movie.id} {...movie} /></Grid.Column>)
                }
            </Grid>
